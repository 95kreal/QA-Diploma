...
public class DebitCardPage {
    ...
    public void checkSuccessNotification(int waitingTimeInSeconds) {
        checkNotification(notificationSuccess, waitingTimeInSeconds, Notifications.paymentSuccess[0], Notifications.paymentSuccess[1]);
    }

    public void checkErrorNotification(int waitingTimeInSeconds) {
        checkNotification(notificationError, waitingTimeInSeconds, Notifications.paymentNoSuccess[0], Notifications.paymentNoSuccess[1]);
    }
    ...
    public static class RegexDebit {
